...
define(function testAknAuthorialNotePlugin(require) {
    ...
    describe(
        ...
        function() {
            var transformationConfigForAknAuthorialNote = '{"akn":"authorialNote","html":"span[class=authorialnote]","attr":[{"html":"class=authorialnote"},{"akn":"marker","html":"marker"},{"akn":"xml:id","html":"id"},{"akn":"leos:origin","html":"data-origin"},{"html":"data-akn-name=aknAuthorialNote"}],"sub":{"akn":"mp","html":"span","attr":[{"akn":"xml:id","html":"data-akn-mp-id"},{"akn":"leos:origin","html":"data-mp-origin"}],"sub":[{"akn":"text","html":"span[title]"}]}}';
