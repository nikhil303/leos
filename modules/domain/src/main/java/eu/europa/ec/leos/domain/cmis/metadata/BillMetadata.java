...
public final class BillMetadata extends LeosMetadata {
    ...
    public BillMetadata(String stage, String type, String purpose, String template, String language, String docTemplate, String ref, String objectId) {
        super(LeosCategory.BILL, stage, type, purpose, template, language, docTemplate, ref, objectId);
    }

    public final BillMetadata withPurpose(String purpose) {
        return new BillMetadata(stage, type, purpose, template, language, docTemplate, ref, objectId);
    }
