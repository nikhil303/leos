...
public class ProposalInstanceTypeResolver implements InstanceTypeResolver {
    ...
    @Nonnull public EditElementResponseEvent createEvent(String elementId, String elementTagName, String elementFragment, String docType, User user,
        ...
        return new EditElementResponseEvent(elementId, elementTagName, elementFragment, docType, user, authorities, InstanceType.COMMISSION.name(), alternatives);
    }
