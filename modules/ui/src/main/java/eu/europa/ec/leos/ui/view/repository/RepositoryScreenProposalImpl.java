...
public class RepositoryScreenProposalImpl extends RepositoryScreenImpl {
    ...
    @Autowired
    RepositoryScreenProposalImpl(SecurityContext securityContext, EventBus eventBus, MessageHelper messageHelper, LanguageHelper langHelper, LeosPermissionAuthorityMapHelper authorityMapHelper) {
